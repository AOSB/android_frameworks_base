...
public class ActiveDisplayView extends FrameLayout {
    ...
    private static final String ACTION_FORCE_DISPLAY = "com.android.systemui.action.FORCE_DISPLAY";

    private static final String ACTION_REDISPLAY_NOTIFICATION = "com.android.systemui.action.REDISPLAY_NOTIFICATION";

    private static final String ACTION_DISPLAY_TIMEOUT = "com.android.systemui.action.DISPLAY_TIMEOUT";
