...
public class ActiveDisplayView extends FrameLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ACTIVE_DISPLAY_QUIET_HOURS), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        public void update() {
            ...
            mQuietTime = Settings.System.getInt(
                    resolver, Settings.System.ACTIVE_DISPLAY_QUIET_HOURS, 0) == 1;
            ...
            hideNonClearable = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.ACTIVE_DISPLAY_HIDE_NON_CLEARABLE, 1) == 1;
            mHideLowPriorityNotifications = Settings.System.getInt(
                    resolver, Settings.System.ACTIVE_DISPLAY_HIDE_LOW_PRIORITY_NOTIFICATIONS, 1) == 1;
            mPocketMode = Settings.System.getInt(
                    resolver, Settings.System.ACTIVE_DISPLAY_POCKET_MODE, POCKET_MODE_ACTIVE_DISPLAY);
